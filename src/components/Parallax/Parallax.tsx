...
const Parallax = () => {
  ...
  return (
    <div className={s.root}>
      <div className={s.smallPokeBall} style={{ transform: `translate(${screenX * 0.03}px, ${screenY * 0.03}px)` }}>
      ...
      <div
        ...
        style={{
          transform: `translate(${screenX * 0.05}px, ${screenY * 0.05}px) scale(${
            (0.95 + screenX * 0.0002 + 0.95 + screenY * 0.0001) / 2
          })`,
        }}>
        <img src={PokeBallPng} alt="Big PokeBall" />
      </div>
      <div className={s.pikachu} style={{ transform: `translate(${screenX * 0.015}px, ${screenY * 0.015}px)` }}>
